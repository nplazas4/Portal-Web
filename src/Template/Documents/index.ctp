...
<script type="text/javascript">
  ...
  $.each(array_general_items, function(a, b){
    var settings = {
      "async": true,
      "crossDomain": true,
      "url": "http://primavera.eeb.com.co:8080/ords/portal/documents/"+this.link,
      "method": "GET",
      "headers": {
  ...
  function gen() {
    var settings = {
      "async": true,
      "crossDomain": true,
      "url": "http://primavera.eeb.com.co:8080/ords/portal/documents/filtergen/",
      "method": "GET",
      "headers": {
        "Authorization": "Bearer <?=$_SESSION["PortalToken"]?>",
        "cache-control": "no-cache"
  ...
  function filter_company(company_id, chart_num) {
      ...
      "async": true,
      "crossDomain": true,
      "url": "http://primavera.eeb.com.co:8080/ords/portal/documents/filtercompany/"+company_id,
      "method": "GET",
      "headers": {
        "Authorization": "Bearer <?=$_SESSION["PortalToken"]?>",
        "cache-control": "no-cache"
  ...
  function filter_project(eps_id, chart_num) {
    var settings = {
      "async": true,
      "crossDomain": true,
      "url": "http://primavera.eeb.com.co:8080/ords/portal/documents/filterproject/?v_eps="+eps_id+"&v_id_user="+user_id,
      "method": "GET",
      "headers": {
        "Authorization": "Bearer <?=$_SESSION["PortalToken"]?>",
        "cache-control": "no-cache"
  ...
  function filter_bp(unifier_code, chart_num) {
    var settings = {
      "async": true,
      "crossDomain": true,
      "url": "http://primavera.eeb.com.co:8080/ords/portal/documents/filterbp/"+unifier_code,
      "method": "GET",
      "headers": {
        "Authorization": "Bearer <?=$_SESSION["PortalToken"]?>",
        "cache-control": "no-cache"
  ...
  function graph1(id_bp){
    var settings = {
      "async": true,
      "crossDomain": true,
      "url": "http://primavera.eeb.com.co:8080/ords/portal/documents/graph1/"+id_bp,
      "method": "GET",
      "headers": {
        "Authorization": "Bearer <?=$_SESSION["PortalToken"]?>",
        "cache-control": "no-cache"
  ...
  function graph2(id_bp){
    var settings = {
      "async": true,
      "crossDomain": true,
      "url": "http://primavera.eeb.com.co:8080/ords/portal/documents/graph2/"+id_bp,
      "method": "GET",
      "headers": {
        "Authorization": "Bearer <?=$_SESSION["PortalToken"]?>",
        "cache-control": "no-cache"
  ...
  function graph3(bp_name){
    ...
    var settings = {
      "async": true,
      "crossDomain": true,
      "url": "http://primavera.eeb.com.co:8080/ords/portal/documents/graph3/"+bp_name,
      "method": "GET",
      "headers": {
        "Authorization": "Bearer <?=$_SESSION["PortalToken"]?>",
        "cache-control": "no-cache"
  ...
  function graph4(unifier_code){
    var settings = {
      "async": true,
      "crossDomain": true,
      "url": "http://primavera.eeb.com.co:8080/ords/portal/documents/graph4/"+unifier_code,
      "method": "GET",
      "headers": {
        "Authorization": "Bearer <?=$_SESSION["PortalToken"]?>",
        "cache-control": "no-cache"
...
function creator() {
  var settings = {
      "async": true,
      "crossDomain": true,
      "url": "http://primavera.eeb.com.co:8080/ords/portal/documents/filtercreator/",
      "method": "GET",
      "headers": {
        "Authorization": "Bearer <?=$_SESSION["PortalToken"]?>",
        "cache-control": "no-cache"
...
function status() {
  var settings = {
      "async": true,
      "crossDomain": true,
      "url": "http://primavera.eeb.com.co:8080/ords/portal/documents/filterstatus/",
      "method": "GET",
      "headers": {
        "Authorization": "Bearer <?=$_SESSION["PortalToken"]?>",
        "cache-control": "no-cache"
...
function bp_reg_contratista(code_unifier){
  var settings1 = {
    "async": true,
    "crossDomain": true,
    "url": "http://primavera.eeb.com.co:8080/ords/portal/documents/bprdc/"+code_unifier,
    "method": "GET",
    "headers": {
      "Authorization": "Bearer <?=$_SESSION["PortalToken"]?>",
      "cache-control": "no-cache"
...
function bp__reg_interno(code_unifier){
  var settings2 = {
    "async": true,
    "crossDomain": true,
    "url": "http://primavera.eeb.com.co:8080/ords/portal/documents/bprdi/"+code_unifier,
    "method": "GET",
    "headers": {
      "Authorization": "Bearer <?=$_SESSION["PortalToken"]?>",
      "cache-control": "no-cache"
...
function bp_reg_externo(code_unifier){
  var settings3 = {
    "async": true,
    "crossDomain": true,
    "url": "http://primavera.eeb.com.co:8080/ords/portal/documents/bprde/"+code_unifier,
    "method": "GET",
    "headers": {
      "Authorization": "Bearer <?=$_SESSION["PortalToken"]?>",
      "cache-control": "no-cache"
