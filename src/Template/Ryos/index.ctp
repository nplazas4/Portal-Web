                    ...
                    <form class="contact100-form validate-form active" id="Form-1" style="padding-bottom: 0 !important">
                        ...
                        <div class="wrap-input100 rs1-wrap-input100 validate-input entrada" id="div-name">
                            ...
                            <span class="icon-download"><i class="material-icons tooltipped" data-position="bottom"
                                  data-tooltip="Requerimientos y oportunidades que tienen potencial para desarrollarse como iniciativa y posteriormente como proyecto en el GEB." onclick="return false;">help_outline</i></span>
                            <input class="input100 entrada tooltipped" data-position="bottom" data-tooltip="Requerimientos y oportunidades que tienen potencial para desarrollarse como iniciativa y posteriormente como proyecto en el GEB." id="input-1"
                              autocomplete="off" type="text" name="nombre" onkeyup="validarTexto(this);" placeholder="Ingrese el nombre del requerimiento u oportunidad">
                        </div>
                        <div class="wrap-input100 rs1-wrap-input100 validate-input entrada" id="div-gestor">
                            ...
                            <input class="input100 entrada" id="input-2" onkeyup="validarTexto(this);" autocomplete="off" type="text" name="gestor" placeholder="Ingrese el gestor">
                        </div>
                        ...
                        <div class="wrap-input100 rs1-wrap-input100 validate-input">
                            ...
                            <div id="div-filial">
                                <select id="select-filial" name="select-entrada">
                        ...
                        <div class="wrap-input100 rs1-wrap-input100 validate-input">
                            ...
                            <div id="div-select-subcategoria" name="select-entrada">
                                <select class="select-subcategoria" id="select-subcategoria" name="select-entrada">
                            ...
                            <!-- <div id="div-select-subcategoria" style="display:none">
                            ...
                            <table class="display highlight centered" id="id-table-dates">
                                ...
                                <tbody>
                                    <tr class="wrap-input100 rs1-wrap-input100 validate-input entrada">
                                        <td>Fase I</td>
                                        <td><input id="input-phase-1" class="input100 entrada table-date datepicker" readonly type="text" style="text-align:center"></td>
                                        <td><input id="input-phase-2" class="input100 entrada table-date datepicker2" readonly type="text" style="text-align:center"></td>
                                    </tr>
                                    <tr class="wrap-input100 rs1-wrap-input100 validate-input entrada">
                                        <td>Fase II</td>
                                        <td><input id="input-phase-3" class="input100 entrada table-date datepicker3" readonly type="text" style="text-align:center"></td>
                                        <td><input id="input-phase-4" class="input100 entrada table-date datepicker4" readonly type="text" style="text-align:center"></td>
                                    </tr>
                                    <tr class="wrap-input100 rs1-wrap-input100 validate-input entrada">
                                        <td>Fase III</td>
                                        <td><input id="input-phase-5" class="input100 entrada table-date datepicker5" readonly type="text" style="text-align:center"></td>
                                        <td><input id="input-phase-6" class="input100 entrada table-date datepicker6" readonly type="text" style="text-align:center"></td>
                                    </tr>
                                    <tr class="wrap-input100 rs1-wrap-input100 validate-input entrada">
                                        <td>Fase IV</td>
                                        <td><input id="input-phase-7" class="input100 entrada table-date datepicker7" readonly type="text" style="text-align:center"></td>
                                        <td><input id="input-phase-8" class="input100 entrada table-date datepicker8" readonly type="text" style="text-align:center"></td>
                                    </tr>
                                    <tr class="wrap-input100 rs1-wrap-input100 validate-input entrada">
                                        <td>Fase V</td>
                                        <td><input id="input-phase-9" class="input100 entrada table-date datepicker9" readonly type="text" style="text-align:center"></td>
                                        <td><input id="input-phase-10" class="input100 entrada table-date datepicker10" readonly type="text" style="text-align:center"></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
            ...
            <i class="material-icons right" aria-hidden="true">send</i>
                    ...
                    <form class="contact100-form validate-form" id="Form-3" style="padding-bottom: 0 !important">
                        ...
                        <div class="wrap-input100 rs1-wrap-input100 validate-input">
                            ...
                            <select id="select-obj-<?=$i?>" name="select-obj-est">
                            </select>
                        </div>
                        ...
                        <div class="div-gen-valor wrap-input100 rs1-wrap-input100 validate-input">
                            ...
                            <select id="select-gen-valor-1">
                            </select>
                        </div>
                        <div class="div-gen-valor wrap-input100 rs1-wrap-input100 validate-input">
                            <span class="label-input100">Aplicación</span>
                            <input class="input100 ti" value="-" onkeyup="validarTexto(this);" autocomplete="off" type="text" name="" placeholder="Ingrese la aplicación">
                        </div>
                        <!-- TI -->
                        <div class="div-gen-valor-ti wrap-input100 rs1-wrap-input100 validate-input">
                            <span class="label-input100" style="color:#fff">text</span>
                            <select id="select-gen-valor-2">
                        ...
                        <div class="div-gen-valor-ti wrap-input100 rs1-wrap-input100 validate-input">
                            <span class="label-input100">Aplicación</span>
                            <input class="input100 ti-exclusive" onkeyup="validarTexto(this);" autocomplete="off" type="text" name="" placeholder="Ingrese la aplicación">
                        </div>
                        <div class="div-gen-valor-ti wrap-input100 rs1-wrap-input100 validate-input">
                            <span class="label-input100" style="color:#fff">text</span>
                            <select id="select-gen-valor-3">
                                <option disabled selected>Seleccione una opción</option>
                                <option class="work-option">Excelencia y eficiencia operacional</option>
                                <option class="work-option">Excelencia y eficiencia operacional</option>
                                <option class="work-option">Integración y adopción de tecnologías del negocio y de la información</option>
                        ...
                        <div class="div-gen-valor-ti wrap-input100 rs1-wrap-input100 validate-input">
                            <span class="label-input100">Aplicación</span>
                            <input class="input100 ti-exclusive" value="-" onkeyup="validarTexto(this);" autocomplete="off" type="text" name="" placeholder="Ingrese la aplicación">
                        </div>
                        <div class="div-gen-valor-ti wrap-input100 rs1-wrap-input100 validate-input">
                            <span class="label-input100" style="color:#fff">text</span>
                    ...
                    <form class="contact100-form validate-form" id="Form-4" style="padding-bottom: 0 !important">
                            ...
                            <table class="display highlight centered">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="input-icons"><i class="material-icons icon">attach_money</i>
                                                <input class="input100 financiera anual-estimate" id="input-cop-anual" autocomplete="off" onkeydown="return event.keyCode !== 69" type="number" min="0.00" max="10000.00" step="0.01" value="0.00"
                                                  style="text-align:center"></div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="input-icons"><i class="material-icons icon">attach_money</i>
                                                <input class="input100 financiera anual-estimate" id="input-usd-anual" autocomplete="off" onkeydown="return event.keyCode !== 69" type="number" min="0.00" max="10000.00" step="0.01" value="0.00"
                                                  style="text-align:center"></div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="input-icons"><i class="material-icons icon">attach_money</i>
                                                <input class="input100 financiera anual-estimate" id="input-eur-anual" autocomplete="off" type="number" onkeydown="return event.keyCode !== 69" min="0.00" max="10000.00" step="0.01" value="0.00"
                                                  style="text-align:center"></div>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="input-icons"><i class="material-icons icon">attach_money</i>
                                                <input class="input100 financiera anual-estimate" id="input-gtq-anual" autocomplete="off" type="number" onkeydown="return event.keyCode !== 69" min="0.00" max="10000.00" step="0.01" value="0.00"
                                                  style="text-align:center"></div>
                                        </td>
                                    </tr>
                                </tbody>
                        ...
                        <div class="wrap-input100 rs1-wrap-input100 validate-input" id="ciclo-div">
                            ...
                            <span class="icon-download"><i class="material-icons tooltipped" data-position="bottom" data-tooltip="Ingrese el tiempo que operará el producto que se genera por la implementación de su RYOS"
                                  onclick="return false;">help_outline</i></span>
                            <input class="input100 financiera" type="number" id="ciclo" autocomplete="off" onkeyup="validarNumero(this);" value="0" onkeydown="return event.keyCode !== 69" style="margin-bottom: 20px"
                        ...
                        <div class="origen-mandatorio wrap-input100 rs1-wrap-input100 validate-input" id="costos-div">
                            ...
                            <input class="input100 financiera" type="number" name="name" id="costos" placeholder="Ingrese los costos" value="0" onkeydown="return event.keyCode !== 69" min="0.00" max="10000.00" step="0.01" autocomplete="off"
                              onkeyup="validarNumero(this);" onkeydown="return event.keyCode !== 69" style="margin-bottom: 20px">
                        </div>
  ...
  $(document).ready(function() {
    ...
    $("#return").click(function() {
        ...
        if ($('#Form-2').is(":visible")) {
            ...
            var empty_inputs = $('.input200').filter(function() {
                return !$(this).val()
            }).length;
        }
        if ($('#Form-3').is(":visible")) {
            // var empty_inputs1 = $('.input100.ti').filter(function() {
            //     return !$(this).val()
            // }).length;
            var empty_inputs2 = $('.input100.form3').filter(function() {
                return !$(this).val()
            }).length;
            console.log(empty_inputs2);
            // var empty_inputs3 = $('.input100.ti-exclusive').filter(function() {
            //     return !$(this).val()
            // }).length;
        ...
        if ($('#Form-4').is(":visible")) {
            var empty_inputs1 = $('.input100.financiera').filter(function() {
                return !$(this).val()
            }).length;
            var empty_inputs2 = $('.input300.financiera').filter(function() {
                return !$(this).val()
            }).length;
        ...
        if ($('#Form-6').is(":visible")) {
            var empty_inputs = $('.risks-input.materialize-textarea').filter(function() {
                return !$(this).val()
            }).length;
            if (empty_inputs == 0) {
                $('#triangule-sec1').removeAttr('style');
    ...
    function inputs_vacios() {
        $('.input100.entrada').filter(function() {
            return !$(this).val()
        }).after('<span class="bubble z-depth-2" style="font-size: small; color:red; margin-top: 10%">Número negativo</span>');
    }
...
function Dynamic_Country() {
    var selected_option = document.getElementById("select-country").value,
        filial;
    $('#input_other_filial').hide();
    $('#input_other_filial *').attr("disabled");
...
$(document).ready(function() {
    $("#return").click(function() {
        ...
        if (select_tipo_proyecto == "SOST") {
            $('#form-title').text(value_subcategoria + ' - ' + 'Información Detallada');
...
// $("select[name=select-obj-est]").change(function(){
//
// });
...
function obj_est_append(objectives) {
    $('select[name=select-obj-est] option').remove();
    $('select[name=select-obj-est]').append(new Option('Seleccione una opción'));
    $.each(objectives, function() {
        $('select[name=select-obj-est]').append(new Option(this));
        $('select[name=select-obj-est]').formSelect();
    });
}
...
function gen_val_append(array_gen_val) {
    $('#select-gen-valor-1 option').remove();
    $('#select-gen-valor-1').append(new Option('Seleccione una opción'));
    $.each(array_gen_val, function() {
        $('#select-gen-valor-1').append(new Option(this));
        $('#select-gen-valor-1').formSelect();
    });
}
</script>
