...
<div class="section bcrumb">
  ...
  $(document).ready(function() {
      $('.work-select').change(function() {
        ...
        var idString = id; /* Guarda el id del select en la variable idString */
           ...
           <div class="form-content">
             ...
             <div class="col s12 m6 offset-m3 l4 offset-l4 z-depth-6 ">
               <fieldset id="field_id">
                ...
                <div class="row">
                  <div class="input-field col s6">
                    <?php echo $this->Form->input('CAPEX_PLANNED',['label'=>'Presupuesto planeado','placeholder'=>'Presupuesto planeado','class'=>'validate','required']);?>
                  </div>
                  <div class="input-field col s6">
                    <?php echo $this->Form->input('CAPEX_EXECUTED',['label'=>'Presupuesto ejecutado','placeholder'=>'Presupuesto ejecutado','class'=>'validate','required']);?>
                  </div>
                </div>
                <div class="row">
                  <div class="input-field col s6">
              ...
              <div class="row">
                ...
                <div class="row mt-5">
                  ...
                  <?php endif;?>
                  <!-- </?php echo $this->Html->link('Excel de carga', '/files/Curva3G.xlsx');?> -->
                </div>
              </div>
            </fieldset>
            <br>
