...
<script>
  ...
  promise.then(function(result) {
    var settings = {
        "async": true,
        "crossDomain": true,
        "url": "http://primavera.eeb.com.co:8080/ords/portal/notebook/list/" + result[1],
        "method": "GET",
        "headers": {
    ...
    // if (unifier_code != null) {
      if (select_value == 'actual' || select_value == 'all-select') {
        var settings = {
            "async": true,
            "crossDomain": true,
            "url": "http://primavera.eeb.com.co:8080/ords/portal/indicatorscosts/list?p_projet_id="+project_id,
            "method": "GET",
            "headers": {
                "Authorization": "Bearer <?=$_SESSION["PortalToken"]?>"
            }
        ...
        var settings = {
            "async": true,
            "crossDomain": true,
            "url": "http://primavera.eeb.com.co:8080/ords/portal/captures/costindicators/?p_project_id="+project_id+"&p_id_capture="+select_value,
            "method": "GET",
            "headers": {
                "Authorization": "Bearer <?=$_SESSION["PortalToken"]?>"
            }
    ...
    promise.then(function (result) {
      ...
      function option_compare_new_dates(id_project, selected_date, unifier_code, chart_side){
        var settings = {
            "async": true,
            "crossDomain": true,
            "url": "http://primavera.eeb.com.co:8080/ords/portal/captures/projects/?project_id="+id_project+"&capture_id="+selected_date,
            "method": "GET",
            "headers": {
                "Authorization": "Bearer <?=$_SESSION["PortalToken"]?>"
            }
      ...
      function crono_indicators_mec(compare_side, selected_date){
        promise.then(function (result) {
          var settings = {
              "async": true,
              "crossDomain": true,
              "url": "http://primavera.eeb.com.co:8080/ords/portal/captures/indicatorsbyproject/?project_id="+result[1]+"&capture_id="+selected_date,
              "method": "GET",
              "headers": {
                  "Authorization": "Bearer <?=$_SESSION["PortalToken"]?>",
                  "cache-control": "no-cache"
  ...
  function donut(result){
    ...
    function caf(result, period_value, select_id){
        var settings = {
            "async": true,
            "crossDomain": true,
            "url": "http://primavera.eeb.com.co:8080/ords/portal/graph/data/?P_PROJECT_ID="+result+"&P_PERIOD_TYPE="+period_value,
            "method": "GET",
            "headers": {
                "Authorization": "Bearer <?=$_SESSION["PortalToken"]?>"
            }
  ...
  function actual_tg(project_id, unifier_code, select_compare, select_side) {
      if (unifier_code != null) {
        var settings = {
            "async": true,
            "crossDomain": true,
            "url": "http://primavera.eeb.com.co:8080/ords/portal/indicatorscosts/curve3g/?p_project_id="+project_id,
            "method": "GET",
            "headers": {
                "Authorization": "Bearer <?=$_SESSION["PortalToken"]?>"
            }
    ...
    select_actual.change(function() {
      ...
      function crono_actual(compare_side){
        promise.then(function (result) {
          var settings = {
              "async": true,
              "crossDomain": true,
              "url": "http://primavera.eeb.com.co:8080/ords/portal/indicators/indicatorsbyproject/"+result[1],
              "method": "GET",
              "headers": {
                  "Authorization": "Bearer <?=$_SESSION["PortalToken"]?>",
                  "cache-control": "no-cache"
      ...
      function advance_compare(id_project, capture_id, chart_side){
        var settings = {
          "async": true,
          "crossDomain": true,
          "url": "http://primavera.eeb.com.co:8080/ords/portal/captures/projectpercent/?v_project_id="+id_project+"&v_historyc_id="+capture_id,
          "method": "GET",
          "headers": {
            "Authorization": "Bearer <?=$_SESSION["PortalToken"]?>",
            "cache-control": "no-cache"
      ...
      function hitos_compare(id_project, selected_date, hitos_body, select_compare){
        var settings = {
          "async": true,
          "crossDomain": true,
          "url": "http://primavera.eeb.com.co:8080/ords/portal/captures/milestone/?v_project_id="+id_project+"&v_capture_id="+selected_date,
          "method": "GET",
          "headers": {
            "Authorization": "Bearer <?=$_SESSION["PortalToken"]?>",
            "cache-control": "no-cache"
      ...
      function compare_tg (id_project, capture_id, chart_side, unifier_code) {
          if (unifier_code != null) {
            var settings = {
                "async": true,
                "crossDomain": true,
                "url": "http://primavera.eeb.com.co:8080/ords/portal/captures/curve3g/?p_project_id="+id_project+"&p_id_capture="+capture_id,
                "method": "GET",
                "headers": {
                    "Authorization": "Bearer <?=$_SESSION["PortalToken"]?>"
                }
